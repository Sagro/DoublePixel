...
export function Hero() {
  return (
    <section id="home" className="relative flex flex-col md:flex-row md:items-stretch overflow-hidden">
        ...
        <div className="max-w-2xl">
          ...
          >
            <div className="flex items-center space-x-3 mb-6">
              ...
              <span className="text-[11px] uppercase tracking-[0.4em] text-[#C6FF00] font-bold">
                Web Design · Strategy
              </span>
            </div>
          </motion.div>
          ...
          >
            Design<br/>che fa la<br/>
            <span className="text-zinc-500">differenza.</span>
          </motion.h1>
          ...
          >
            ...
            <div className="flex -space-x-2">
              <div className="w-8 h-8 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-[10px]">01</div>
              <div className="w-8 h-8 rounded-full bg-[#C6FF00] border border-black flex items-center justify-center text-[10px] text-black font-bold">+14</div>
            </div>
          </motion.div>
      ...
      <div className="w-full md:w-1/2 bg-[#0F0F0F] p-6 py-16 md:p-12 lg:p-20 flex flex-col justify-between md:min-h-[100svh] relative z-10">
        <motion.div 
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          <div className="mt-auto md:mb-auto">
            <div className="flex justify-between items-end mb-6">
              <h4 className="text-[10px] uppercase tracking-[0.3em] font-bold opacity-50">Servizi Core</h4>
              <span className="text-[10px] font-mono">[01—04]</span>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
              <div className="flex flex-col">
                <span className="text-xl font-bold italic font-display">01</span>
                <span className="text-[10px] uppercase tracking-tighter font-semibold">Web Development</span>
              </div>
              <div className="flex flex-col">
                <span className="text-xl font-bold italic font-display text-[#C6FF00]">02</span>
                <span className="text-[10px] uppercase tracking-tighter font-semibold">Digital Strategy</span>
              </div>
              <div className="flex flex-col">
                <span className="text-xl font-bold italic font-display">03</span>
          ...
          <div className="mt-12 flex flex-col gap-4">
            ...
            <div className="w-full h-[1px] bg-white/10 relative overflow-hidden">
              <motion.div 
                className="absolute top-0 left-0 h-full w-1/3 bg-[#C6FF00]"
